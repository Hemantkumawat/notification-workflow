...
const StepTemplate = ({ title, subtitle, icon }) => {
  return (
    <button className="relative bg-white hover:bg-slate-100 text-black font-bold py-2 px-4 rounded border-indigo-300 border">
